...
#              old wrapper wrote only /etc/sddm.conf.d/, which plasmalogin never opens.
...
assert_has "…where autologin was actually written" "sddm.conf.d/00-auros-matrix-autologin.conf" "$T_LAST_OUT"
