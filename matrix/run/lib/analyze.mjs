...
function parseArgs(a) {
  ...
  for (let i = 0; i < a.length; i++) {
    ...
    const k = a[i].slice(2);
    // An EMPTY value is still a value: run-static.sh passes `--recipe ""` for a base build, and
    // reading that as the flag "true" turned every base build into a recipe named "true".
